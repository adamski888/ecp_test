...
def fetch_all_records(user=None):
    conn = connect_db()
    cur = conn.cursor()
    if user:
...
WZORCOWE_ZADANIA = [
    ("[NC] Zakładanie umawiania RUMBA PL",              "00:10:00"),
    ("[NC] Weryfikacja umawiania RUMBA +  TENS",        "00:06:00"),
    ("[NC] Zakładanie Potwierdzen RUMBA + TENS",        "00:07:00"),
    ("[NC] Weryfikacja Potwierdzen RUMBA + TENS",       "00:04:30"),
    ("[NC] Zakładanie 1,5H TENS +  RUMBA",              "00:06:00"),
    ("[NC] Weryfikacja 1i5h RUMBA PL + TENS",           "00:02:00"),
    ("[NC] Zakładanie Przekładki RUMBA + TENS",         "00:06:00"),
    ("[NC] Weryfikacja Przekładki RUMBA + TENS",        "00:02:00"),
    ("[NC] Zakładanie Umawiania TENS PL",               "00:13:00"),
    ("[NC] Zakładanie FOTO PL",                         "00:18:00"),
    ("[NC] Weryfikacja FOTO PL",                        "00:20:00"),
    ("[NC] Zakładanie Umawianie RO",                    "00:03:50"),
    ("[NC] Zakładanie Potwierdzanie RO",                "00:06:00"),
    ("[NC] Zakładanie 1,5h RO",                         "00:04:00"),
    ("[NC] Zakładanie Przekładki RO",                   "00:07:06"),
    ("[NC] Zakładanie Umawiania",                       "00:01:40"),
    ("[NC] Zakładanie potwierdzen",                     "00:04:10"),
    ("[NC] Zakładanie 1i5",                             "00:02:10"),
    ("[NC] Zakładanie + Weryfikacja Umawiania UM 24",   "00:14:05"),
    ("[NC] Weryfikacja Umawiania UM 24 - TECHNICZNA WERYFIKACJA", "00:02:00"),
    ("[NC] Zakładanie + Weryfikacja Potwierdzanie UM 24", "00:12:30"),
    ("[NC] Zakładanie FOTO HR",                         "00:15:00"),
    ("[NC] Zakładanie UMAWIANIE",                       "00:06:00"),
    ("[NC] Zakładanie POTW",                            "00:07:00"),
    ("[NC] Zakładanie 1.5H",                            "00:07:04"),
    ("[NC] Zakładanie UMAWIANIE (RĘCZNIE)",             "00:12:46"),
    ("[NC] Zakładanie UMAWIANIE (z plików na serwerze)","00:02:44"),
    ("Zakładanie Umawiania BG",                         "00:03:50"),
    ("[NC] Zakładanie Potwierdzanie BG",                "00:06:00"),
    ("[NC] Zakładanie 1,5h BG",                         "00:04:00"),
    ("[NC] Zakładanie Przekładki BG",                   "00:07:06"),
    ("Poprawka - CYRKI",                                None),
    ("Poprawka - FOTO",                                 None),
    ("Nowy projekt - CYRKI",                            None),
    ("Nowy projekt - FOTO",                             None),
    ("Zapotrzebowanie - CYRKI",                         None),
    ("Zapotrzebowanie - FOTO",                          None),
    ("Weryfikacja statusów - CYRKI",                    None),
    ("Weryfikacja statusów - FOTO",                     None),
    ("Weryfikacja poprawek - CYRKI",                    None),
    ("Weryfikacja poprawek - FOTO",                     None),
    ("Przygotowywanie instrukcji - CYRKI",              None),
    ("Przygotowywanie instrukcji - FOTO",               None),
    ("Poprawka",                                        None),
    ("Zapotrzebowanie",                                 None),
    ("Nowy projekt",                                    None),
    ("Weryfikacja statusów",                            None),
    ("Weryfikacja poprawek",                            None),
    ("Przygotowywanie instrukcji",                      None)
]
    ...
    def aktualizuj_tabele(*_):
        ...
        for osoba, kraj, zadanie, data, czas_od, czas_do, opis, ilosc in records:
            ...
            if data and data.strftime("%d.%m.%Y") == dzien:
                key = osoba
                czasy_pracy.setdefault(key, []).append((str(czas_od), str(czas_do), zadanie, ilosc))
